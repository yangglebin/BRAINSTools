...
class SessionDB():
    ...
    def getSessionsFromGroup(self, groups):
        """ Return a dictionary of groups with valid sessions, e.g. {group: [session,...], ...}

        Keyword Arguments:
        self   -- SessionDB object
        groups -- dict of group keys with list of sessions
        ...
        ...   return db.getSessionsFromGroup(groups)
        >>> test()
