...
if(NOT IS_DIRECTORY ${TBB_ROOT})
  message(FATAL_ERROR "TBB_ROOT MUST BE SET")
endif()
...
if ( NOT TBB_ROOT )
    ...
    FIND_PACKAGE_HANDLE_STANDARD_ARGS( TBB DEFAULT_MSG TBB_LIBRARY TBB_MALLOC_LIBRARY
      # TBB_LIBRARY_DEBUG
      # TBB_MALLOC_LIBRARY_DEBUG
      TBB_INCLUDE_DIRS TBB_ROOT)
